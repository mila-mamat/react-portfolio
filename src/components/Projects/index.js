...
function Projects() {
  ...
  return (
    // <!-- projects  -->
    <section id="projects" class="y-center text-center bg-gray">
      ...
      <div class="container  p-3 my-3">
        <div class="row projects mx-lg-5 bg-white">
          <article class="col-md-6">
            ...
            <p>
              A web based post and photo sharing social network that has like and comment features
            </p>
            <hr />
            <div>
              <ul class="list-inline mb-0 mx-auto">
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Sequelize
                  </span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Node</span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Express</span>
                </li>
              </ul>
            </div>
          </article>
          <article class="col-md-6">
            ...
            <p>
              A web application that helps one with organizing and planning
              their daily life conveniently
            </p>
            <hr />
            <div>
              <ul class="list-inline mb-0 mx-auto">
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Google Calendar API
                  </span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">OAuth 2.0</span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">UIkit</span>
                </li>
              </ul>
            </div>
          </article>
          <article class="col-md-6">
            ...
            <p>
              A web based order tracking system to help burger store kitchen with their daily orders
            </p>
            <hr />
            <div>
              <ul class="list-inline mb-0 mx-auto">
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Node
                  </span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">MySQL</span>
                </li>
                ...
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Handlebar</span>
                </li>
              </ul>
            </div>
          ...
          <article class="col-md-6">
            ...
            <p>
              A web application that can be used to write, save, edit and delete notes
            </p>
            <hr />
            <div>
              <ul class="list-inline mb-0 mx-auto">
                ...
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">jquery</span>
                </li>
              </ul>
            </div>
          </article>
          <article class="col-md-6">
            ...
            <div>
              <ul class="list-inline mb-0 mx-auto">
                ...
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Inquirer</span>
                </li>
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">MySQL</span>
                </li>
          ...
          <article class="col-md-6">
            ...
            <p>
              A Node CLI that takes in information about a software engineering team and generates an HTML webpage that
            ...
            <div>
              <ul class="list-inline mb-0 mx-auto">
                ...
                <li class="list-inline-item">
                  <span class="badge-secondary badge-pill">Jest</span>
                </li>
              </ul>
            </div>
          </article>
